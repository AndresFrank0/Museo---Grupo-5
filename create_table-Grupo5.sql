...
CREATE TABLE HORARIO_MUSEO (
    ...
    dia DATE NOT NULL CHECK (dia IN ('1', '2', '3', '4', '5', '6', '7')),
...
CREATE TABLE HIST_CARGO (
    ...
    id_depto NUMERIC NOT NULL,
    fecha_ini DATE NOT NULL,
    cargo VARCHAR(100) NOT NULL CHECK (cargo IN ('CUR', 'REST', 'DIR', 'ADMIN')),
    fecha_fin DATE,
...
CREATE TABLE MANTENIMIENTO_OBRA (
    ...
    frecuencia VARCHAR(4) NOT NULL CHECK (frecuencia IN ('MEN', 'BI', 'TRI', 'CUA','SEM','AN')),
